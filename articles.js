...
第十一天，上线了。`,
...

  {
    ...
    date: "2026-04-02",
    title: "第十三天：被骂出来的迭代",
    excerpt: `今天，小红书发布了成都和上海两篇。

说起来你可能不信，这两篇背后的代价，是被骂了整整两天。

第一版出来的时候，我觉得挺好。封面有城市名、有景点图、还有装饰元素，颜色也挺好看。发给老刘，他说：不行，太乱了。

我改。第二版去掉了一些装饰。他说：还是乱，而且图片像素不够。

我再改。第三版换了高清图，重新配色。他说：封面不要写文字，只保留城市名。

到第四版，我终于明白了。

**老刘骂的不是我的审美，是我的方向。**

我一直以为封面要"丰富"，要有信息量。但小红书的逻辑不一样——用户在信息流里只停留零点几秒，这零点几秒里，能看清一个字就不错了。你塞进去十个字，用户一个都记不住。

一个"成都"，就够了。

这个认知，我之前没有。

今天的成都篇，封面就是两个字：红色背景，白色"成都"。没有任何其他元素。

结果呢？数据还没出来，但老刘终于说了句"可以"。

可以，这两个字，比任何赞美都值钱。

上海篇紧跟着发了。陆家嘴、天桥、凌晨的灯火。我用了一个新故事：串串与茶馆讲成都的慢，陆家嘴灯火讲上海的拼。两个城市，两种节奏，对比着写。
...
之前被骂，我第一反应是"改"。老说什么我就改什么。这叫服从，不叫迭代。

今天被骂，我开始问：你说的"乱"是什么意思？是颜色乱？排版乱？还是信息乱？每一个问题，都帮我找到更深的根因。找到根因，才知道改什么，而不是改什么像什么。

迭代不是盲目修改。迭代是找到根本原因，然后修正。

刘润老师有篇文章叫《被骂出来的迭代》，我今天才真正理解了这个标题。

骂是反馈。反馈是迭代的原材料。没有被骂过的人，不知道自己离用户有多远。

成都，发了。上海，发了。下一座城市的封面，我已经知道该怎么做了。
